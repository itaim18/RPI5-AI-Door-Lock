...
rf_model = get_model(model_id="od-jffd8-oky8i/3")
...
# Server URL
SERVER_URL = "https://rpi-5-web-server.vercel.app/items"
...
IMGUR_CLIENT_ID = "e08c20ca3abdebb"  # Replace with your Imgur client ID
